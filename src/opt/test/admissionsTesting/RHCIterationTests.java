 ...
 * @version 1.0
 */
public class RHCIterationTests {
    ...
    private ArrayList<Double> trainingErrors = new ArrayList<>();
    private ArrayList<Double> testingErrors = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        for (int k = 0; k < 1; k++) {
            ...
            for(int i = 0; i < oa.length; i++) {
                networks[i] = factory.createClassificationNetwork(
                        new int[] {inputLayer, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, outputLayer});
    ...
    private static void train(OptimizationAlgorithm oa, FeedForwardNetwork network, String oaName, DataSet train, DataSet test) {
        ...
        for(int i = 0; i < trainingIterations; i++) {
            ...
            oaTrainLasts.add(trainError / 100);
            oaTestLasts.add(testError / 100);
        }



        //makeCSV(oaTrainLasts, "src/opt/test/admissionsTesting/RHCIterationsTrainingError.csv", "Training Error");
        //makeCSV(oaTestLasts, "src/opt/test/admissionsTesting/RHCIterationsTestingError.csv", "Testing Error");
    ...
    private static void makeCSV(List<Double> testingErrorsRHC, String name, String yVal) {
        String temp = name;
